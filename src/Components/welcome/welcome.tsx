...
//     <div className="app">
//       <header>
//         <img src="simbi-logo.png" alt="Simbi Logo" className="logo" />
//         <div className="user-info">
...
//       <main>
//         <h1 className="title">
//           Welcome to <span className="simbi">Simbi</span>
//         </h1>
//         <p className="subtitle">Your AI Study Buddy</p>
//         <p className="desc">
//           Complete the 3 steps to get a personalised study plan and content
...
//               {currentStep === 0 && (
//                 <>
//                   <label>What level of education are you currently in?</label>
//                   <select>
//                     <option>Educational level</option>
//                     <option>High School</option>
//                     <option>University</option>
...
//               {currentStep === 2 && (
//                 <>
//                   <label>Which tone do you prefer SIMBI to use?</label>
//                   <button className="option-btn">Playful and funny</button>
//                   <button className="option-btn">Calm and supportive</button>
//                   <button className="option-btn">Straight to the point</button>
//                 </>
...
//               <button className="next-btnn" onClick={handleNext}>
//                 Next
//               </button>
//             </div>
//           </div>

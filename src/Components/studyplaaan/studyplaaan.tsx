...
const STUDYPLAAAN: React.FC = () => {
  ...
  const addSession = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const errorText = await res.text();
        console.error("Failed to add session:", errorText);
      }
    } catch (error) {
  ...
  const renderSessionCard = (s: Session, className: string) => (
    <div
      key={s._id}
      className={className}
      ...
      <div className="studyplan-content">
        ...
        <div className="section">
          ...
          {sessions
            ...
            .map((s) => renderSessionCard(s, "session-card-all"))}
        </div>
        ...
        <div className="section">
          ...
          {sessions
            ...
            .map((s) => renderSessionCard(s, "session-card-missed"))}
        </div>

        <div className="section">
          <h2>All Scheduled Sessions</h2>
          {sessions.map((s) => renderSessionCard(s, "session-card-all"))}
        </div>

            ...
            <div className="lp-feats">
              ...
              <div className="lp-feature">
                ...
                <div>
                  ...
                  <p>
                    You pick your pace. Get daily study plans that fit your
                    vibe.
                  </p>
                </div>
              </div>
              <div className="lp-feature">
                ...
                <div>
                  <div>
                    ...
                    <p>
                      Ask questions, get study tips, or stay hyped — SIMBIs
              ...
              <div className="lp-feature">
                ...
                <div>
                  ...
                  <p>
                    Practice smarter with instant feedback and quizzes tailored
                    to you.
                  </p>
                </div>
              </div>
        ...
        <section className="testimonials-section">
          ...
          <div className="testimonials-container">
            ...
            <div className="testimonial-card">
              ...
              <p className="quote">
                “The personalized plans and motivational chats with SIMBI help
                me stay focused — even on days when I feel tired. Its like
                having a coach in my pocket.”
              </p>
            ...
            <div className="testimonial-card">
              ...
              <p className="quote">
                ...
                helped me study better and stay relaxed. SIMBI is the best thing
                I downloaded this year.”
              </p>

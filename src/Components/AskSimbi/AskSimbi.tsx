  ...
  return (
    <div className="chat-container">
      <div className="chat-wrapper">
        ...
        >
          <img src="/assets/icons/Simbi-logo.svg" alt="logo" width="60%" />
          <img src="/assets/icons/cuida_sidebar.svg" alt="collapse" width="15%" />
        </div>
                  ...
                  {entry.questions.map((q, qIdx) => (
                    <li key={qIdx}>
                      <button
                        ...
                        onClick={() => handleHistoryClick(q.question, q.answer)}
                      >
                        {q.question.length > 20 ? q.question.slice(0, 17) + "..." : q.question}
                      </button>
                    </li>
                  ))}
                </ul>
      ...
      <div className="asksimbi-container">
        <div className="cancel-button-div">
          <button onClick={() => navigate("/quizPage")} className="cancel-button">
            Dashboard
          </button>
        </div>
